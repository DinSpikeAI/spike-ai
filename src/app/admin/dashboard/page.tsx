          ...
          <div className="space-y-4">
            {creatorsLoading ? <div className="flex items-center justify-center py-20"><Loader2 size={24} className="animate-spin text-white/20" /></div> : creators.length === 0 ? <div className="text-center py-20 text-white/20">No creators yet</div> : (
              <div className="bg-[#111114] border border-white/[0.06] rounded-2xl overflow-hidden">
                <div className="grid grid-cols-12 gap-4 px-5 py-3 text-[10px] font-bold tracking-[0.15em] uppercase text-white/20 border-b border-white/[0.04]"><div className="col-span-1"></div><div className="col-span-3">Name</div><div className="col-span-3">Email</div><div className="col-span-1 text-center">Films</div><div className="col-span-2">Role</div><div className="col-span-2">Joined</div></div>
                {creators.map(c => (

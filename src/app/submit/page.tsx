...
export default function SubmitPage() {
  ...
  return (
    <div className="min-h-screen bg-[#08080c] text-white relative overflow-hidden">
      ...
      {/* Master container — flexbox centered */}
      <main className="relative z-10 flex flex-col items-center w-full px-6 sm:px-8 pb-24">
        {/* Hero */}
        <header className="text-center pt-2 pb-12 sm:pb-16 w-full max-w-[1200px]">
          <h1
        ...
        {/* 2-column flex layout — centered as a block */}
        <div className="flex flex-col lg:flex-row justify-center gap-10 lg:gap-12 w-full max-w-[1200px]">

          {/* ─── LEFT: FORM ─── */}
          <div className="w-full lg:w-[560px] lg:flex-shrink-0 space-y-6">

            <section className="rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm p-6 space-y-5">
            ...
            <section className="rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm p-6 space-y-4">
          ...
          <div className="w-full lg:w-[380px] lg:flex-shrink-0 lg:sticky lg:top-8">
            <div className="space-y-6">
              <div>
                <p className="text-[11px] font-semibold tracking-[0.2em] uppercase text-zinc-500 mb-3">Live Preview</p>
                <div className="rounded-2xl overflow-hidden border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl shadow-2xl shadow-black/40 transition-all duration-500 hover:shadow-[0_0_40px_rgba(139,92,246,0.1)] hover:border-purple-500/20">
                  <div className="aspect-[2/3] relative flex items-center justify-center overflow-hidden">
                    {form.poster_url ? (
                      ...
                      <div className="absolute inset-4 border-2 border-dashed border-white/[0.08] rounded-xl flex items-center justify-center">

...
const COLLECTIONS = [
  { id: "col-anime", title: "AI Anime", subtitle: "Neural-powered animation", image: "https://picsum.photos/seed/col-anime/800/450", genre: "Anime" },
    ...
    <footer className="px-5 md:px-12 py-12 md:py-20 border-t border-white/[0.03]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex gap-8 mt-8 text-xs font-light tracking-wider text-white/25">
          ...
          <a href="#" className="hover:text-white/50 transition-colors">Help Center</a>
        </div>
        <p className="text-[11px] font-light tracking-wider text-white/15 mt-10">
          © 2026 Spike AI. All rights reserved. All content is AI-generated.
        </p>
      </div>
    </footer>
  );
